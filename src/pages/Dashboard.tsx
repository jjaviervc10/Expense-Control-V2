    ...
    <div className="min-h-screen bg-gray-100 p-6 relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen bg-transparent p-6">
        ...
        <header className="flex flex-col items-center justify-center mb-10 relative">
          <div className="flex items-center w-full max-w-4xl mx-auto justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-blue-700 text-lg">{user?.nombre || "Usuario"}</span>
            </div>
            <button
              onClick={logout}
          ...
          <p className="text-gray-600 mt-2 text-base font-medium">Selecciona el tipo de reporte</p>
        </header>
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <Link 
            to="/gastos/diario"
            className="bg-white shadow-lg rounded-xl p-8 text-center hover:shadow-xl hover:scale-105 transition transform cursor-pointer border-t-4 border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-400 group"
            tabIndex={0}
            aria-label="Ver reporte diario"
          >
            <div className="flex flex-col items-center justify-center mb-2">
              <CalendarDaysIcon className="w-10 h-10 text-blue-500 group-hover:scale-110 transition" />
            </div>
          ...
          <Link 
            to="/gastos/semanal"
            className="bg-white shadow-lg rounded-xl p-8 text-center hover:shadow-xl hover:scale-105 transition transform cursor-pointer border-t-4 border-green-400 focus:outline-none focus:ring-2 focus:ring-green-400 group"
            tabIndex={0}
            aria-label="Ver reporte semanal"
          >
            <div className="flex flex-col items-center justify-center mb-2">
              <CalendarIcon className="w-10 h-10 text-green-500 group-hover:scale-110 transition" />
            </div>
          ...
          <Link 
            to="/gastos/mensual"
            className="bg-white shadow-lg rounded-xl p-8 text-center hover:shadow-xl hover:scale-105 transition transform cursor-pointer border-t-4 border-purple-400 focus:outline-none focus:ring-2 focus:ring-purple-400 group"
            tabIndex={0}
            aria-label="Ver reporte mensual"
          >
            <div className="flex flex-col items-center justify-center mb-2">
              <ChartBarIcon className="w-10 h-10 text-purple-500 group-hover:scale-110 transition" />
            </div>
        ...
        <div className="flex justify-center mt-4">
          <Link to="/analisis" className="inline-flex items-center gap-2 bg-blue-700 hover:bg-blue-800 text-white font-semibold px-6 py-3 rounded-lg shadow-lg transition text-lg">
